          ...
          <div className="sportify-card p-3.5 border-amber-500/25 bg-amber-500/[0.02] space-y-2">
            ...
            <div className="space-y-1.5">
              {devAreas.length > 0 ? (
                ...
                <div className="p-3 text-center rounded-lg bg-white/[0.02] text-xs text-slate-500">
                  No secondary development areas.
                </div>
              )}
            </div>
          </div>
            ...
            <div className="space-y-1.5">
              {proficient.length > 0 ? (
                proficient.map((item) => (
                  <div
                    key={item.attribute}
                    className="p-2 rounded-lg bg-white/[0.04] border border-white/10 text-xs"
                  >
            ...
            <div className="space-y-1.5">
              {strengths.length > 0 ? (
                strengths.map((item) => (
                  <div
                    key={item.attribute}
                    className="p-2 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-xs"
                  >
                    ...
                    <div className="text-[10px] text-emerald-300/80 mt-0.5 font-mono">
                      Above Benchmark (+{Math.abs(item.gap)} pts)
                    </div>
                  </div>
                ))
              ) : (
